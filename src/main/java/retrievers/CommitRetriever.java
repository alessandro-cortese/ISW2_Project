...
public class CommitRetriever {
    ...
    public List<JavaClassModifies> retrieveChanges(@NotNull RevCommit commit) throws IOException {
        ...
        try(DiffFormatter diffFormatter = new DiffFormatter(DisabledOutputStream.INSTANCE)) {
            ...
            for (DiffEntry entry : entries) {
                JavaClassModifies newChangedJavaClass = new JavaClassModifies(entry.getNewPath());
